...
**目录**: [`drawio-architect/`](drawio-architect/)
...
**详细文档**: [`drawio-architect/SKILL.md`](drawio-architect/SKILL.md)
...
**目录**: [`solution-expert/`](solution-expert/)

根据业务场景或功能清单生成总体技术解决方案文档（6章节）。

| 特性 | 说明 |
|------|------|
| **文档结构** | 项目概述 → 需求分析 → 技术架构 → 应用架构 → 基础设施 → 实施计划 |
| **固定技术栈** | Vue3 + Ant Design + Spring Boot + MySQL |
| **受众分层** | 业务决策层、技术架构师分别适配表达策略 |
| **自动补全** | 隐式推断缺失需求、非功能需求默认值 |
...
**触发词**: `技术方案`、`总体方案`、`实施方案`、`交付方案`、`解决方案`、`技术交底书`、`投标方案`

**不适用**: 代码级设计、单模块架构、分布式微服务系统

**详细文档**: [`solution-expert/SKILL.md`](solution-expert/SKILL.md)
...
**目录**: [`saas-ui-design/`](saas-ui-design/)
...
**详细文档**: [`saas-ui-design/SKILL.md`](saas-ui-design/SKILL.md)
...
dainthub-skills/
├── README.md                           # 项目说明（本文件）
├── drawio-architect/               # draw.io 架构图技能
│   ├── SKILL.md                        # 技能主文件
│   └── references/                     # 参考文档
