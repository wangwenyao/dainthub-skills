...
| git pull / 拉取同步 / 检查变更 | 拉取同步流程 | `../team-collaboration/references/06-sync-flow.md` |
| 项目初始化 / 协同开发 / 分布式协作 | 协同开发概述 | `../team-collaboration/references/01-overview.md` |
| 目录结构 / 项目结构 | 项目目录结构 | `../team-collaboration/references/02-project-structure.md` |
| status.md / 归档 / 状态更新 | 状态快照与归档 | `../team-collaboration/references/05-status-mechanism.md` |
