...
version: 1.0
description: |
  Use when 企业信息系统需要产品经理工作：写PRD、需求文档、功能设计、产品规划、用户故事、线框图、页面原型。
  触发：梳理需求、整理功能点、写产品方案、功能怎么设计、产品逻辑、产品需求文档、生成线框图、页面原型、设计页面结构、偏差决策、接受技术建议。
  不适用：UI视觉设计（ui-ux-pro-max）、技术实现方案（tech-manager）、纯代码开发、竞品分析。
---
