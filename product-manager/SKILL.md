...
| **协同开发** | 多会话，git 协作 | 加载 team-collaboration + 状态更新 |
...
| 文档 | 独立开发 | 协同开发 |
|------|---------|---------|
| 本 skill workflows (requirement-analysis 等) | ✅ 加载 | ✅ 加载 |
| 本 skill references (prd-template 等) | ✅ 加载 | ✅ 加载 |
| `sync-flow.md` (拉取同步) | ❌ 不加载 | ✅ 加载 |
| `status-mechanism.md` (状态同步) | ❌ 不加载 | ✅ 加载 |
| `skill-router.md` (角色→Skill映射) | ❌ 不加载 | ✅ 加载 |
...
| 角色→Skill 映射 / 了解各角色职责 | `../team-collaboration/references/10-skill-router.md` |
| status.md / 归档 / 状态更新 | `../team-collaboration/references/05-status-mechanism.md` |
| 阻塞处理 / 偏差阻塞流程 | `../team-collaboration/references/11-blocking-handler.md` |
...
| 文档 | 用途 | 何时加载 |
|------|------|----------|
| `workflows/requirement-analysis.md` | 需求分析流程 | 分析需求/排优先级 |
| `workflows/product-design.md` | 产品设计流程 | 设计产品方案 |
| `workflows/business-modeling-flow.md` | 业务建模流程 | 业务建模/角色定义 |
| `workflows/function-architecture-design.md` | 功能架构设计流程 | 功能拆解 |
| `workflows/prd-writing.md` | PRD编写流程 | 写PRD |
| `workflows/wireframe-generation.md` | 线框图生成流程 | 生成线框图 |
| `workflows/deviation-handling.md` | 偏差反馈处理流程 | 处理偏差反馈 |
| `prd-template.md` | PRD模板 | 编写PRD时 |
| `prd-writing-guide.md` | PRD编写规范 | 编写PRD时 |
| `requirement-analysis.md` | 需求分析方法论（KANO/MoSCoW） | 需求分析 |
| `product-design.md` | 产品设计方法论 | 产品设计 |
| `business-modeling.md` | 业务建模规范 | 业务建模 |
| `wireframe-layout-templates.md` | 线框图布局模板 | 生成线框图 |
...
| `../team-collaboration/references/10-skill-router.md` | 角色→Skill映射 + 路由规则 | 了解角色职责 |
| `../team-collaboration/references/11-blocking-handler.md` | 阻塞处理规范 | 遇到阻塞 |
| `../team-collaboration/references/12-status-update-templates.md` | 状态更新模板 | skill 完成后更新 status.md |
